        ...
        <div className='entry' data-aos='fade-up' data-aos-once='true'>
          ...
          <div className='aboutinfo'>
            ...
            <p className='text-base'>
              ...
              <br /><br />
              <strong>Clustering Movement Data:</strong> Using U.S. Census data and SafeGraph mobility patterns, we group census block groups (CBGs) to reveal how populations interact and move within a city. Our algorithm produces dynamic map visualizations that showcase these connections over time, offering insights into the interconnectedness of neighborhoods.
              <br /><br />
              <strong>Modeling Realistic Movement Patterns:</strong> We build synthetic populations that replicate real-world movement behaviors. By simulating interactions at homes, workplaces, and community spaces, we capture the complexity of daily life, integrating travel and daily routines to create a flexible framework.
            </p>
          </div>
        </div>
